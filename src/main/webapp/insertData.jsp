...
<body>
	...
	<h1>Add Data</h1>
    <form action="InsertData" onsubmit="return validation()">
        <div class="mainBox">
            <div>
                <label>Name : </label>
            ...
            <div>
                ...
                <input type="tel" id="mobile" name="mobile" maxlength="10" placeholder="enter the number">
            </div>
            <div>
                <label>Password : </label>
                <input type="password" id="passw" name="passw1" placeholder="enter the password">
            </div>
            <div>
                <label>Confirm Password : </label>
                <input type="password" id="passw2" name="passw2" placeholder="enter confirm password">
            </div>
            <div>
